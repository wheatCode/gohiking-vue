<template>
  <section>
    <v-toolbar color="success" class="white--text">
      ...
      <v-toolbar-title>隱私權政策</v-toolbar-title>
    </v-toolbar>

    <v-card elevation="2" rounded="0" class="overflow-y-auto" style="height: calc(100vh - 50px)">
      <v-card-text class="px-5 pb-5">
        服務條款<br /><br />認知與接受條款<br />
        ...
        <br />
        若您為未滿二十歲，除應符合上述規定外，並應於您的家長（或監護人）閱讀、瞭解並同意本服務條款之所有內容及其後修改變更後，方得使用或繼續使用本服務。當您使用或繼續使用本服務時，即推定您的家長（或監護人）已閱讀、瞭解並同意接受本服務條款之所有內容及其後修改變更。<br /><br />
        與第三人網站的連結<br />
        本服務或協力廠商可能會提供連結至其他網站或網路資源的連結。<br />
        您可能會因此連結至其他業者經營的網站，但不表示 GO HIKING 與該等業者有任何關係。<br />
        其他業者經營的網站均由各該業者自行負責，不屬 GO HIKING 控制及負責範圍之內。<br />
        GO HIKING
        對任何檢索結果或外部連結，不擔保其合適性、可依賴性、即時性、有效性、正確性及完整性。<br />
        您並同意 GO HIKING 無須為您連結至非屬於 GO HIKING
        之網站所生之任何損害，負損害賠償之責任。<br /><br />
        您的註冊義務<br />
        為了能使用本服務，您同意以下事項：<br />
        提供您本人正確、最新及完整的資料<br />
        維持並更新您個人資料，確保其為正確、最新及完整。若您提供任何錯誤、不實或不完整的資料， GO
        HIKING 有權暫停或終止您的帳號，並拒絕您使用本服務之全部或一部。<br />
        隱私權政策<br />
        關於您的會員註冊以及其他特定資料依 GO HIKING 「隱私權政策」受到保護與規範。<br /><br />
        會員帳號、密碼及安全<br />
        完成本服務的登記程序之後，您有責任維持密碼及帳號的機密安全。您並同意以下事項：<br />
        您的密碼或帳號遭到盜用或有其他任何安全問題發生時，您將立即通知 GO HIKING<br />
        每次連線完畢，均結束您的帳號使用。<br /><br />
        *兒童及青少年之保護*<br />
        為確保兒童及青少年使用網路的安全，並避免隱私權受到侵犯，家長（或監護人）應盡到下列義務：<br />
        先檢閱各該網站是否有保護個人資料的「隱私權政策」，再決定是否同意提出相關的個人資料；並應持續叮嚀兒童及青少年不可洩漏自己或家人的任何資料（包括姓名、地址、電話、電子郵件信箱、照片、信用卡號等）給任何人。也不可以單獨接受網友的邀請或贈送禮物而與之見面。<br />
        謹慎選擇合適網站供兒童及青少年瀏覽。未滿十二歲之兒童上網時，應全程在旁陪伴，十二歲以上未滿十八歲之青少年上網前亦應斟酌是否給予同意。<br /><br />
        *使用者的守法義務及承諾*<br />
        您同意並保證不得利用本服務從事侵害他人權益或違法之行為，包括但不限於：<br />
        張貼、公布或傳送任何誹謗、侮辱、具威脅性、攻擊性、不雅、猥褻、不實、違反公共秩序或善良風俗或其他不法之文字、圖片或任何形式的檔案於本服務上；<br />
        侵害他人名譽、隱私權、營業秘密、商標權、著作權、專利權、其他智慧財產權及其他權利；<br />
        違反依法律或契約所應負之保密義務；<br />冒用他人名義使用本服務；<br />
        上載、張貼、傳輸或散佈任何含有電腦病毒或任何對電腦軟、硬體產生中斷、破壞或限制功能之程式碼之資料；<br />
        從事不法交易行為或張貼虛假不實、引人犯罪之訊息；<br />
        販賣槍枝、毒品、禁藥、盜版軟體或其他違禁物； 提供賭博資訊或以任何方式引誘他人參與賭博；<br />
        濫發廣告郵件、垃圾郵件、連鎖信、違法之多層次傳銷訊息等； 以任何方法傷害未成年人；<br />
        偽造訊息來源或以任何方式干擾傳輸來源之認定；<br />
        干擾或中斷本服務或伺服器或連結本服務之網路，或不遵守連結至本服務之相關需求、程序、政策或規則等，包括但不限於：使用任何設備、軟體或刻意規避
        GO HIKING 之排除自動搜尋之標頭 (robot exclusion headers)；<br />
